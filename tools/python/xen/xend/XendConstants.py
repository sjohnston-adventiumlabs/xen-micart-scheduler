...
#
#  micart schedule constants
#
XEN_MIC_OPTION_NONE = int(0)
XEN_MIC_OPTION_SLACK = int(1)
XEN_MIC_OPTION_REALTIME = int(2)
XEN_MIC_OPTION_HELPER = int(4)
XEN_MIC_OPTION_NEW = int(8)

XEN_MIC_FUNCTION_SLICE  = int(0)
XEN_MIC_FUNCTION_CLEAR= int(1)
XEN_MIC_FUNCTION_SWAP = int(2)
XEN_MIC_FUNCTION_OPTS = int(3)
XEN_MIC_FUNCTION_SET = int(5)
XEN_MIC_FUNCTION_GET = int(6)
